...
export default function Fromexternal() {
    ...
    useEffect(() => {
        const init = async () => {
            ...
            let lastNumber = await axios.get(process.env.REACT_APP_API + '/external/lastnumberbook',
    ...
    const onFinish = async (value) => {
        const data = { ...value, type_data: typedata, number_book: newBook, img_external: fileName }
        console.log(data);
        //value.number_book = newBook;
        console.log("values => ", value)
        let result = await axios.post(process.env.REACT_APP_API + '/external-insert', data,
