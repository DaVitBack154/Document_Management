...
export default function Frominternaldoc() {
    ...
    useEffect(() => {
        const init = async () => {
            ...
            let lastNumber = await axios.get(process.env.REACT_APP_API + '/internaldoc/lastnumberbook',
    ...
    const onFinish = async (value) => {
        const data = { ...value, type_data: typedata, number_book: newBook, img_internal_doc: fileName }
        console.log(data);
        //value.number_book = newBook;
        console.log("values => ", value)
        let result = await axios.post(process.env.REACT_APP_API + '/internaldoc-insert', data,
