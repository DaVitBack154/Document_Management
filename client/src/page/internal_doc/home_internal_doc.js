...
import Tableinternaldoc from './table-internal-doc'
...
export default function HomeInternalDoc() {
    ...
    useEffect(() => {
        const init = async () => {
            ...
            try {
                let datareport = await axios.get(process.env.REACT_APP_API + '/report-internaldoc',
                ...
                let dataexternal = await axios.get(process.env.REACT_APP_API + '/internaldoc',
                    { params: params, withCredentials: true })
    ...
    const handleClick = async () => {
        try {
            ...
            let excelColumn = [
                ...
                {
                    title: 'image',
                    dataIndex: 'img_internal_doc',
                },
            ]

            const excel = new Excel()
            excel
                .addSheet('report_internaldoc')
                .addColumns(excelColumn)
                .addDataSource(excel_internal)
                .saveAs('report-internaldoc.xlsx')
        } catch (error) {
            console.error(error)
        }
    }
                ...
                <div className='group-internal'>
                    <div className='head-table'>
                        ...
                        <div className='btn-add'>
                            <NavLink to={'/fromint-chase/CHASE'}>
                                <button className='btn-inter'>
                                    <IoMdAddCircle className='add' />
                                    CHASE
                                </button>
                            </NavLink>
                            <NavLink to={'/fromint-rway/RWAY'}>
                                <button className='btn-inter'>
                                    <IoMdAddCircle className='add' />
                                    RWAY
                                </button>
                    ...
                    <div>
                        <Tableinternaldoc data={interdata} setData={setInterdata} key='1' onChange={onChange} />
                        <br />
                    </div>
                </div>
            </div>
