...
export default function Fullinternaldoc() {
    const [externaldata, setExternaldata] = useState([])

    useEffect(() => {
        const init = async () => {
            try {
                let dataexternal = await axios.get(process.env.REACT_APP_API + '/internaldoc-alldata',
        ...
        <HomepageFull>
            ...
            <div className='border-table'>
                <div className='group-internal'>
                    ...
                    <div>
                        <Tableinternaldoc data={externaldata} setData={setExternaldata} key='1' />
                        <br />
                    </div>
                </div>
            </div>
