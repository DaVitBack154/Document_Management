...
export default function Homeethics() {
  ...
  const column = [
    {
      ...
      width: 50,
      render: (_, record) => (
        <NavLink to={'/fromethics/' + record.id}>
  ...
  useEffect(() => {
    const init = async () => {
      let regisdoc = await axios.get(process.env.REACT_APP_API + '/ethics', {
          ...
          <div className="head-table">
            <div className="box-flex">
              <div className="text-dash">
                <div className="head-db">จรรยาบรรณธุรกิจ/นโยบาย</div>
                <div className="text-dash">Table ˃ จรรยาบรรณธุรกิจ/นโยบาย</div>
              </div>
            </div>

            <div className="btn-add">
              <NavLink to={'/fromethics'}>
