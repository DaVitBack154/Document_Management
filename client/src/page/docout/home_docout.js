...
export default function Homedocout() {
  ...
  const column = [
    {
      ...
      width: 50,
      render: (_, record) => (
        <NavLink to={'/fromdocout/' + record.id}>
    ...
    {
      title: 'วันที่ลงในเอกสาร',
      dataIndex: 'date_doc',
    },
    {
      title: 'วันที่ได้รับเอกสาร',
      dataIndex: 'date_recive',
    },
    {
      title: 'การตอบกลับ',
      dataIndex: 'respond',
    ...
    {
      title: 'สถานที่จัดเก็บต้นฉบับ',
      dataIndex: 'location_meet',
    },
    {
      title: 'หมายเหตุ',
      dataIndex: 'remark',
  ...
  useEffect(() => {
    const init = async () => {
      let regisdoc = await axios.get(process.env.REACT_APP_API + '/docout', {
          ...
          <div className="head-table">
            <div className="box-flex">
              <div className="text-dash">
                <div className="head-db">เอกสารที่ได้รับจากภายนอก</div>
                <div className="text-dash">
                  Table ˃ เอกสารที่ได้รับจากภายนอก
                </div>
              </div>
            </div>

            <div className="btn-add">
              <NavLink to={'/fromdocout'}>
